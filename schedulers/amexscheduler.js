...
function PostCode() {
    ...
    var post_data = 'brandname=&TARGET=&request_type=IntlLogLogonHandler&Logon=Continue...&act=soa&cardsmanage=cards&UserID='+process.argv[2]+'&Password='+process.argv[3];
